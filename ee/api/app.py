...
from routers.subs import health, spot, product_analytics, mcp, user_reports
...
app.include_router(user_reports.public_app)
app.include_router(user_reports.app)
app.include_router(user_reports.app_apikey)
